...
# create an instance of a new staff member
new_staff = Staff(f_name='', l_name='', password='')

# create a staff member name from input
...
# create a password protected system for staff to be able to modify flight_trip
while user_input != 'x':
    user_input_b = input("enter a new password or press 'x' to quit: ")
    if user_input_b == 'x':
        sys.exit('Thank you, have a nice day')
    # assign password to specific staff name
    ...
    if user_input_c == user_input_b:
        ...
        while user_input_a != 'x':
            ...
            # create instance of new_ticket
            new_ticket = Tickets(aircraft_number='', age='', ticket_price='', available_tickets=int())

            # create instance of new passenger
            new_passenger = Passengers(f_name='', l_name='', passport_number='')

            # sell tickets according to age
            ...
            # create a flight_attendees_list_report +
